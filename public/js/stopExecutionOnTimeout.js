...
window.CP.PenTimer = {
    ...
    _throwAnErrorToStopPen: function() {
        throw "We found an infinite loop in your Pen. We've stopped the Pen from running. Please correct it or contact."
    },
...
window.CP.shouldStopExecution = function(o) {
    ...
    return t === !0 && console.warn("An infinite loop (or loop taking too long) was detected, so we stopped its execution. Sorry!"),
    t
}
,
